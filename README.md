...
Download the current beta from [GitHub Releases](https://github.com/vashisht7/StudyBuddy/releases/tag/v1.0.0-beta.1).

| Edition | Download | Use it when |
|---|---|---|
| Standard Mac | [StudyBuddy-1.0.0-arm64.dmg](https://github.com/vashisht7/StudyBuddy/releases/download/v1.0.0-beta.1/StudyBuddy-1.0.0-arm64.dmg) | You already use Ollama, or only need the reader and local workspace |
| Portable Mac | [StudyBuddy-1.0.0-arm64-mac.zip](https://github.com/vashisht7/StudyBuddy/releases/download/v1.0.0-beta.1/StudyBuddy-1.0.0-arm64-mac.zip) | You prefer an application ZIP |
| Complete Offline Mac | [Release assets and joining instructions](https://github.com/vashisht7/StudyBuddy/releases/tag/v1.0.0-beta.1) | You want Ollama and Gemma 3 4B included |
| Website | [StudyBuddy-1.0.0-Website.zip](https://github.com/vashisht7/StudyBuddy/releases/download/v1.0.0-beta.1/StudyBuddy-1.0.0-Website.zip) | You want to host or inspect the web build |
